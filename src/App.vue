    ...
    <md-app md-waterfall md-mode="fixed">
      <md-app-toolbar class="md-primary" md-elevation="1">
        ...
        <div class="md-toolbar-section-end" :key="$route.fullPath">
          <md-button class="md-primary" v-if="!isLoggedin" to="/login">
            <md-icon>login</md-icon> Login</md-button
          >
          <md-button class="md-primary" v-if="isLoggedin" v-on:click="logout">
  ...
  methods: {
    ...
    logout: function () {
      firebase
        ...
        .signOut()
        .then(() => {
          this.$confirm("Are you sure you want to logout?", "Logout").then(
            () => {
